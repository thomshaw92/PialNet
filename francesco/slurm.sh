...
srun -n 1 python3 francesco/src/predict.py --ckp_path checkpoints/SEG-ckp_20210113_124904/ --input_path PialNet_data/test/raw/imageData.nii --label_path PialNet_data/test/seg/segmentationData.nii
